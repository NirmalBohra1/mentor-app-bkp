    ...
    <Collapsible
      ...
      header={
        <Box py={4}>
          ...
          <HStack align="middle">
            <Text color="#666" fontSize='11px' fontWeight={300}>Total 34</Text>
            <Text fontSize='8px' color="#666" mx={2}>●</Text>
            <Text color="#666" fontSize='11px' fontWeight={300}>Present 28</Text>
          </HStack>
        </Box>
      }
    >
            ...
            <VStack space={6}>
              ...
              <Box>
                <VStack space={6}>
                  ...
                  <Text><Text bold>Note:</Text> <Text color="#333333">Monthly Report will be generated on the last day of every month.</Text></Text>
                </VStack>
              </Box>
            </VStack>
          </Box>
