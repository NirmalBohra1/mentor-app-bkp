...
import {
  ...
  HStack,
  Avatar,
  Divider, Actionsheet, Stack, Button
} from "native-base";
import {
  DEFAULT_THEME,
  H2,
    ...
    <>
      ...
      >
        ...
        <Box w="100%" p={4} justifyContent="center" bg="white">
          <Actionsheet.Item onPress={()=> {setViewBy('grade'); setAcademicDetailModal(false)}}>Grade</Actionsheet.Item>
          <Actionsheet.Item onPress={()=> {setViewBy('gender'); setAcademicDetailModal(false)}}>Gender</Actionsheet.Item>
          <Actionsheet.Item onPress={()=> {setViewBy('category'); setAcademicDetailModal(false)}}>Category</Actionsheet.Item>
        </Box>
      </Actionsheet>
  </>
  );
